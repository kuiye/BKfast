 ...
 */
public class MenuActivity_guanyu extends Activity implements OnClickListener {
	/*
    ...
    */
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.slidemenu_guanyu);
	    /*
			侧边栏声明
	    */
		...
		listener0 = new OnClickListener() {
			...
			public void onClick(View view) {
				Intent intent0 = new Intent(MenuActivity_guanyu.this,MainActivity.class);
...
//				intent0.putExtras(bl);
				...
				MenuActivity_guanyu.this.finish();
			}
		};
		/*
		 * 菜单列-个人中心 点击监听事件
		...
		listener1 = new OnClickListener() {
			@Override
			public void onClick(View view) {
				Intent intent1 = new Intent(MenuActivity_guanyu.this,LoginActivity.class);
		...
		listener2 = new OnClickListener() {
			@Override
			public void onClick(View view) {
				Intent intent2 = new Intent(MenuActivity_guanyu.this,MenuActivity_guanyu.class);
		...
		listener3 = new OnClickListener() {
			@Override
			public void onClick(View view) {
				Intent intent3 = new Intent(MenuActivity_guanyu.this,MenuActivity_wodedingdan.class);
		...
		listener4 = new OnClickListener() {
			@Override
			public void onClick(View view) {
				Intent intent4 = new Intent(MenuActivity_guanyu.this,MenuActivity_yijianfakui.class);
